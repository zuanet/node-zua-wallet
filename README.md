...
- `amount` - Amount of ZUA in base units (sompis)
...
- *available* - balance contains ZUA ready to be spent, comprised of UTXO records with block maturity blue score over 10.
