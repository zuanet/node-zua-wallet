import zuacore from '@zua/core-lib';
import { ZuaAPI } from 'wallet/apiHelpers';

export type Network = 'zua' | 'zuadev' | 'zuareg' | 'zuatest' | 'zuasim';
export type bytes = string;//base84 string

export * from './rpc';
import {IRPC, RPC} from './rpc';
import { ZuaAPI } from './apiHelpers';
